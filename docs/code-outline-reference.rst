Code Outline Reference Document
===============================

This document provides a complete reference for the BTR-TOOLS codebase organization, function indices, and development guidelines.

Project Overview
----------------

**BTR-TOOLS v2.3.0** is a comprehensive command-line toolkit for analyzing, repairing, and exporting data from legacy Btrieve database files.
